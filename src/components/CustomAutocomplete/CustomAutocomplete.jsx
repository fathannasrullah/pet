/**
 * get from:
 * https://codesandbox.io/s/magical-dhawan-d1w57?file=/CustomAutoComplete.js
 */
...
import autocompleteClasses, {
    getAutocompleteUtilityClass
} from '@mui/material/Autocomplete/autocompleteClasses'
...
const Autocomplete = React.forwardRef(function Autocomplete(inProps, ref) {
    ...
    const hasClearIcon = !disableClearable && !disabled && dirty && !isEmpty(value)
    const hasPopupIcon =
                                ...
                                {hasClearIcon ? (
                                    <AutocompleteClearIndicator
                                        ...
                                        className={clsx(
                                            ...
                                            componentsProps.clearIndicator ? componentsProps.clearIndicator.className : null,
                                        )}
                                    >
                                        {clearIcon}
                                    </AutocompleteClearIndicator>
            ...
            {popupOpen && anchorEl ? (
                ...
                >
                    <AutocompletePaper
                        ...
                        className={clsx(classes.paper, componentsProps.paper ? componentsProps.paper.className : null )}
                    >
